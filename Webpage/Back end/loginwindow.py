...
def user_login(user_name, user_password):
    ...
    if user_name == "Siddhant@gmail.com" and user_password == "Alpha":
        welcome()
        input()
        clear()
        user_dashboard()
    elif user_name != "Siddhant@gmail.com" and user_password != "Alpha":
...
def login():
    ...
    response = input("Press (L) to Login       Press (C) to Create Account\n>")
